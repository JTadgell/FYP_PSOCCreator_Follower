...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=65535, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_M2, CY_INSTANCE_SHORT_NAME=PWM_M2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=PWM_M2, )
module PWM_v3_30_2 (
    reset,
    clock,
    tc,
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=M2QuadDec, CY_INSTANCE_SHORT_NAME=M2QuadDec, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=M2QuadDec, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=M1QuadDec:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=M1QuadDec_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=M1QuadDec, CY_INSTANCE_SHORT_NAME=M1QuadDec, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=M1QuadDec, )
...
module top ;
    ...
    PWM_v3_30_1 PWM_M1 (
        ...
        .ph1(Net_703),
        .ph2(Net_704));
    defparam PWM_M1.Resolution = 16;


	cy_clock_v1_0
		#(.id("1c1d015a-670b-4b1b-be42-a0641b3dc613"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__M1_FWD_net;
	wire [0:0] tmpFB_0__M1_FWD_net;
	wire [0:0] tmpIO_0__M1_FWD_net;
	wire [0:0] tmpINTERRUPT_0__M1_FWD_net;
	electrical [0:0] tmpSIOVREF__M1_FWD_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		M1_FWD
		 (.oe(tmpOE__M1_FWD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M1_FWD_net[0:0]}),
		  .io({tmpIO_0__M1_FWD_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_FWD_net),
		  .interrupt({tmpINTERRUPT_0__M1_FWD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_FWD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M1_BWD_net;
	wire [0:0] tmpFB_0__M1_BWD_net;
	wire [0:0] tmpIO_0__M1_BWD_net;
	wire [0:0] tmpINTERRUPT_0__M1_BWD_net;
	electrical [0:0] tmpSIOVREF__M1_BWD_net;

	cy_psoc3_pins_v1_10
		#(.id("48a0bff4-6745-484a-ab45-06053e57b619"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M1_BWD
		 (.oe(tmpOE__M1_BWD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M1_BWD_net[0:0]}),
		  .io({tmpIO_0__M1_BWD_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_BWD_net),
		  .interrupt({tmpINTERRUPT_0__M1_BWD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_BWD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_2 PWM_M2 (
        ...
        .ph1(Net_715),
        .ph2(Net_716));
    defparam PWM_M2.Resolution = 16;

	wire [0:0] tmpOE__M2_FWD_net;
	wire [0:0] tmpFB_0__M2_FWD_net;
	wire [0:0] tmpIO_0__M2_FWD_net;
	wire [0:0] tmpINTERRUPT_0__M2_FWD_net;
	electrical [0:0] tmpSIOVREF__M2_FWD_net;

	cy_psoc3_pins_v1_10
		#(.id("e3ae1969-7f47-4149-9a12-069d07bcb35e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M2_FWD
		 (.oe(tmpOE__M2_FWD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M2_FWD_net[0:0]}),
		  .io({tmpIO_0__M2_FWD_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_FWD_net),
		  .interrupt({tmpINTERRUPT_0__M2_FWD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_FWD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M2_BWD_net;
	wire [0:0] tmpFB_0__M2_BWD_net;
	wire [0:0] tmpIO_0__M2_BWD_net;
	wire [0:0] tmpINTERRUPT_0__M2_BWD_net;
	electrical [0:0] tmpSIOVREF__M2_BWD_net;

	cy_psoc3_pins_v1_10
		#(.id("42513536-4677-403f-9a32-1f1be3dfac38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M2_BWD
		 (.oe(tmpOE__M2_BWD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M2_BWD_net[0:0]}),
		  .io({tmpIO_0__M2_BWD_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_BWD_net),
		  .interrupt({tmpINTERRUPT_0__M2_BWD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_BWD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b9f55225-5d53-4bd5-8473-a0c50e670d28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1406cb8e-9428-4911-9f54-788199b95eb3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Standby_net;
	wire [0:0] tmpFB_0__Standby_net;
	wire [0:0] tmpIO_0__Standby_net;
	wire [0:0] tmpINTERRUPT_0__Standby_net;
	electrical [0:0] tmpSIOVREF__Standby_net;

	cy_psoc3_pins_v1_10
		#(.id("448926e4-81be-4c2c-9df2-9a80819dff5f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Standby
		 (.oe(tmpOE__Standby_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Standby_net[0:0]}),
		  .io({tmpIO_0__Standby_net[0:0]}),
		  .siovref(tmpSIOVREF__Standby_net),
		  .interrupt({tmpINTERRUPT_0__Standby_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Standby_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M2_Phase2_net;
	wire [0:0] tmpIO_0__M2_Phase2_net;
	wire [0:0] tmpINTERRUPT_0__M2_Phase2_net;
	electrical [0:0] tmpSIOVREF__M2_Phase2_net;

	cy_psoc3_pins_v1_10
		#(.id("79286413-a581-4276-9601-e2aa5aa270a5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M2_Phase2
		 (.oe(tmpOE__M2_Phase2_net),
		  .y({1'b0}),
		  .fb({Net_756}),
		  .io({tmpIO_0__M2_Phase2_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_Phase2_net),
		  .interrupt({tmpINTERRUPT_0__M2_Phase2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_Phase2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M2_Phase1_net;
	wire [0:0] tmpIO_0__M2_Phase1_net;
	wire [0:0] tmpINTERRUPT_0__M2_Phase1_net;
	electrical [0:0] tmpSIOVREF__M2_Phase1_net;

	cy_psoc3_pins_v1_10
		#(.id("80cd5ce9-3c55-4298-957f-cfbc9dd01096"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M2_Phase1
		 (.oe(tmpOE__M2_Phase1_net),
		  .y({1'b0}),
		  .fb({Net_755}),
		  .io({tmpIO_0__M2_Phase1_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_Phase1_net),
		  .interrupt({tmpINTERRUPT_0__M2_Phase1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_Phase1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    QuadDec_v3_0_4 M2QuadDec (
        .quad_A(Net_755),
        .quad_B(Net_756),
        .index(1'b0),
        .clock(Net_4),
        .interrupt(Net_758));
    defparam M2QuadDec.CounterResolution = 4;
    defparam M2QuadDec.UsingGlitchFiltering = 1;
    defparam M2QuadDec.UsingIndexInput = 0;


	cy_clock_v1_0
		#(.id("aeeb38bd-e7c3-46e8-88cb-e970bf71ded5"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__M1_Phase2_net;
	wire [0:0] tmpIO_0__M1_Phase2_net;
	wire [0:0] tmpINTERRUPT_0__M1_Phase2_net;
	electrical [0:0] tmpSIOVREF__M1_Phase2_net;

	cy_psoc3_pins_v1_10
		#(.id("5ccc7cc4-5e58-4ba3-bbaf-044ffcb68e45"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M1_Phase2
		 (.oe(tmpOE__M1_Phase2_net),
		  .y({1'b0}),
		  .fb({Net_751}),
		  .io({tmpIO_0__M1_Phase2_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_Phase2_net),
		  .interrupt({tmpINTERRUPT_0__M1_Phase2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_Phase2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M1_Phase1_net;
	wire [0:0] tmpIO_0__M1_Phase1_net;
	wire [0:0] tmpINTERRUPT_0__M1_Phase1_net;
	electrical [0:0] tmpSIOVREF__M1_Phase1_net;

	cy_psoc3_pins_v1_10
		#(.id("dbc8c9fb-6245-4d16-91b5-f411d45b24e1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M1_Phase1
		 (.oe(tmpOE__M1_Phase1_net),
		  .y({1'b0}),
		  .fb({Net_750}),
		  .io({tmpIO_0__M1_Phase1_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_Phase1_net),
		  .interrupt({tmpINTERRUPT_0__M1_Phase1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_Phase1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    QuadDec_v3_0_6 M1QuadDec (
        .quad_A(Net_750),
        .quad_B(Net_751),
        .index(1'b0),
        .clock(Net_4),
        .interrupt(Net_753));
    defparam M1QuadDec.CounterResolution = 4;
    defparam M1QuadDec.UsingGlitchFiltering = 1;
    defparam M1QuadDec.UsingIndexInput = 0;

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_12));

    Timer_v2_70_7 Timer_1 (
        .reset(Net_12),
        .interrupt(Net_744),
        .enable(1'b1),
        .trigger(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("1c97b18b-7da2-4c83-844d-4f75c797cb1b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
